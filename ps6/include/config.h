...
#define INIT_ADDR 1023 // the address of the last byte in the EEPROM
#define INIT_KEY 69 // key for first time initialization

#define IR_PIN 3 // pin for the IR receiver